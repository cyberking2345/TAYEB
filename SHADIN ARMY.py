...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://t.me/shadincyber")
logo =("""
███████╗██╗  ██╗ █████╗ ██████╗ ██╗███╗   ██╗
██╔════╝██║  ██║██╔══██╗██╔══██╗██║████╗  ██║
███████╗███████║███████║██║  ██║██║██╔██╗ ██║
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝╚═╝  ╚═══╝
\033[1;91m╔═════════════════════════╗
\033[1;92m   	ᏀᏆҒͲ ᏴƳ SHADIN ARMY
\033[1;91m╚═════════════════════════╝
""") 
 
def Alhaj():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/shadinahmed235')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
    ...
    if Alhaj in ["2","B"]:
        os.system('xdg-open https://www.facebook.com/shadinahmed235')
    if Alhaj in ["3","C"]:
        os.system('xdg-openhttps://facebook.com/groups/283007881276028/')
    if Alhaj in ["0","X"]:
        os.system('exit')
...
def Alhajs():
    ...
    os.system('clear')
    os.system('xdg-open https://facebook.com/groups/283007881276028/')
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM ALHAJ ')
    print("\033[1;91m╚═══════════════════════════╝")
